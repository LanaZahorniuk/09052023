...
public class Lottery {
    public static void main(String[] args) {
        ...
        System.out.println("Введите номер от 1 до "+range+", номера не должны повторяться. Удачи!");
        System.out.print("Введите 1-й номер: ");
        userNum1 = scanner.nextInt();
        /* do {
            System.out.print("Введите 1-й номер: ");
            userNum1 = scanner.nextInt();
        } while (userNum1 < 0 || userNum1 > 50); */ // чтобы не вводить более 50
        ...
        for(int i = 0; i < setSize; i++){
            ...
            switch (luckyCount){
                case 1 :
                    ...
                    break;
                case  2 :
                    if(lucky1 != lucky) { // чтобы не генерил одинаковые числа
                        lucky2 = lucky;
                        luckyCount++;
                    }
                    break;
        ...
        System.out.println("Номера пользователя: "+userNum1+", "+userNum2+", "
                +userNum3+", "+userNum4+", "+userNum5);
    }
}
